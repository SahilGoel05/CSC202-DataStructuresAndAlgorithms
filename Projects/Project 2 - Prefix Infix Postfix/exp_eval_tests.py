...
class test_expressions(unittest.TestCase):
    ...
    def test_postfix_eval_01e(self) -> None:
        self.assertAlmostEqual(postfix_eval("128 8 2 ** /"), 2)
    ...
    def test_postfix_eval_05a(self) -> None:
        try:
            postfix_eval("1.1 2.2 >>")
            self.fail()     # pragma: no cover
        except PostfixFormatException as e:
    ...
    def test_infix_to_postfix_6(self) -> None:
        self.assertEqual(infix_to_postfix("8 >> 2 ** 2"), "8 2 >> 2 **")

    def test_infix_to_postfix_7(self) -> None:
        self.assertEqual(infix_to_postfix("8 + 2 >> 1 ** 3"), "8 2 1 >> 3 ** +")
